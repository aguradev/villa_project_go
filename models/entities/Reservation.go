...
func (r *Reservation) GetReservationRequest(request request.ReservationRequest, price_per_day decimal.Decimal, userId *uuid.UUID, villaId *uuid.UUID, check_in_date *time.Time) {
